...
Research
======
My current research primarily focuses on investigating beyond the standard model (BSM) neutrino physics especially using astrophysical probes. Top few interesting questions that keep me occupied : 
...
* What is the resolution for the short-baseline neutrino anomalies ? 
...
======
* **May 2026**:  
- My bug fixes for MESA neutrino energy loss rates were successfully reviewed and approved by the MESA developers, and are now available as a dedicated branch of the main code repository [(link)](https://github.com/MESAHub/mesa/tree/bugfix/neu_plasmon_cooling/neu/private).  
